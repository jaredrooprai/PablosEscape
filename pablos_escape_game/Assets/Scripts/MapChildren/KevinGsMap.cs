...
{ 
	...
	void setupItems(){
		...
		*/
		...
		spawnPrefab(12, -6, trapTile);
		spawnPrefab(16, 10, trapTile);
		spawnPrefab(17, 9, trapTile);
		spawnPrefab(17, 10, trapTile);
		spawnPrefab(18, 2, trapTile);
		spawnPrefab(18, 3, trapTile);
		spawnPrefab(18, 8, trapTile);
		spawnPrefab(18, 9, trapTile);
		spawnPrefab(18, 10, trapTile);
		spawnPrefab(19, 3, trapTile);
		spawnPrefab(19, 9, trapTile);
		spawnPrefab(19, 10, trapTile);
		//spawnPrefab(20, 3, trapTile);
		spawnPrefab(20, 4, trapTile);
		spawnPrefab(20, 5, trapTile);
		spawnPrefab(20, 6, trapTile);
		spawnPrefab(20, 10, trapTile);
